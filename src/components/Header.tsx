...
class Header extends Component {
  ...
  handleScroll = () => {
    const currentScrollStatus = window.scrollY > 100;
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <SiteMetaData />
        <Navbar className={`Navbar ${this.state.isActive} ${this.state.isScrolled}`} expand="lg">
          <Container>
            <Link to="/" className="Header-Logo Logo">
              Spencer Marx
            </Link>
            <Navbar.Toggle className="Navbar-Toggle" aria-controls="basic-navbar-nav" onClick={this.handleClick}>
            ...
            <Navbar.Collapse className="Navbar-Collapse" id="basic-navbar-nav">
              <Nav className="ml-auto my-4">
                ...
                <Link to="/posts" className="Header-Links">
                  Posts
                </Link>
