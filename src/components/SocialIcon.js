    ...
    if (icon === 'email') {
        ...
        return (
            <Span className="SocialIcon-Wrapper d-flex justify-content-center align-items-center"
                ...
                color={color}>
                <svg className="SocialIcon" width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M57.0556 39.9882V27L80 47.0235L57.0556 67.0471V53.7341C40.6667 53.7341 29.1944 61.6353 21 73C24.2778 56.7647 34.1111 43.2353 57.0556 39.9882Z" fill="black" />
                </svg>
