...
class ProjectCard extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Card className="ProjectCard" key="front" onClick={this.onClick}>
          <ProjectThumbnail fluid={fluid} />
          <Card.Body className="text-center">
            <Card.Title className="ProjectCard-Type">{projectType}</Card.Title>
            <Card.Subtitle className="ProjectCard-Title">
              {projectTitle}
            </Card.Subtitle>
          </Card.Body>
        </Card>
        <Card className="ProjectCard" key="back" onClick={this.onClick}>
          <Card.Body>
            <h4
              className="ProjectCard-Tech text-center"
            ...
            <Row>
              {technologies.slice(0, 6).map(tech => (
                <Col
                  xs={5}
                  className="ProjectCard-Tech-Wrapper"
                  style={{ background: themeColor, color: '#FFF' }}
                  key={tech}
                >
                  <p className="ProjectCard-Tech-Name text-center" key={tech}>
                    {tech}
                  </p>
                </Col>
              ))}
            </Row>
            <p className="ProjectCard-Short-Description text-center mt-3 mb-4">
              {shortDescription}
            </p>
            {showSource ? (
              <Row>
